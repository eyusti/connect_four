...
if __name__ == "__main__":
    p1 = multiprocessing.Process(target=play_games, args=("minmax2_w_f","rng","depth of 3"))
    #p2 = multiprocessing.Process(target=play_games, args=("rng","minmax2_w_f","depth of 3"))
