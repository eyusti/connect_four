...
if __name__ == "__main__":
    # play_games("montecarlo", "human", "1")
    p1 = multiprocessing.Process(target=play_games, args=("montecarlo","minmax2_w_f","100"))
    #p2 = multiprocessing.Process(target=play_games, args=("montecarlo","minmax2_w_f","100"))
    #p3 = multiprocessing.Process(target=play_games, args=("montecarlo","minmax2_w_f","100"))
    #p4 = multiprocessing.Process(target=play_games, args=("montecarlo","minmax2_w_f","100"))
